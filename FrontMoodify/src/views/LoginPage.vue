<template>
  <div class="min-h-screen flex items-center justify-center bg-black">
    <div class="text-center w-[600px] text-green-500 space-y-5 bg-[#1e1e1e] p-10 rounded-xl">
      ...
      <button
        class="w-full border border-green-500 rounded-lg py-2 flex items-center justify-center space-x-2 hover:bg-green-600 hover:text-white transition">
        <svg class="w-5 h-5" viewBox="0 0 168 168" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M84,0C37.7,0,0,37.7,0,84s37.7,84,84,84s84-37.7,84-84S130.3,0,84,0z M121.3,120.1c-1.5,2.5-4.7,3.3-7.2,1.8
